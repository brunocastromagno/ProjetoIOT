...
# Função para gerar relatório de todos os registros de uma tabela
def gerar_relatorio(table):
    conn = sqlite3.connect('inventario.db')
    cursor = conn.cursor()
...
adicionar_buttons = [
    ("empresa", ["Nome Empresa", "CNPJ Empresa", "Endereço Empresa"]),
